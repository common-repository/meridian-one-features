...
class Meridian_One_About_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'meridian_one_about_widget', // Base ID
			esc_html__( 'MeridianOne - About', 'meridian-one-features' ), // Name
			array( 
				'description' => esc_html__( 'Show an about item.', 'meridian-one-features' ),
	...
	public function widget( $args, $instance ) {
		...
		?>
			...
			<div class="section-about-item">
				...
				<?php if ( $icon ) : ?>
					<span class="section-about-item-icon"><span class="fa <?php echo esc_attr( $icon ); ?>"></span></span>
				<?php endif; ?>

				<?php if ( $heading ) : ?>
					<h4 class="section-about-item-title"><?php echo esc_html( $heading ); ?></h4>
				<?php endif; ?>

				<?php if ( $content ) : ?>
					<div class="section-about-item-description"><?php echo wp_kses_post( $content ); ?></div>
				<?php endif; ?>

			</div><!-- .section-about-item -->
	...
	public function form( $instance ) {
		...
		// Get values
		if ( isset( $instance[ 'title' ] ) ) $title = $instance[ 'title' ]; else $title = 'About Item';
