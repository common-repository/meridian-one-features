...
class Meridian_One_Process_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'meridian_one_process_widget', // Base ID
			esc_html__( 'MeridianOne - Process', 'meridian-one-features' ), // Name
			array( 
				'description' => esc_html__( 'Show a process.', 'meridian-one-features' ),
	...
	public function widget( $args, $instance ) {
		...
		?>
			...
			<div class="section-process-item">
				<span class="section-process-item-number"></span>
				<?php if ( $heading ) : ?>
					<h4 class="section-process-item-title"><?php echo esc_html( $heading ); ?></h4>
				<?php endif; ?>
				<?php if ( $content ) : ?>
					<div class="section-process-item-description"><?php echo wp_kses_post( $content ); ?></div>
				<?php endif; ?>
			</div><!-- .section-process-item -->
	...
	public function form( $instance ) {
		...
		// Get values
		if ( isset( $instance[ 'title' ] ) ) $title = $instance[ 'title' ]; else $title = 'Process';
